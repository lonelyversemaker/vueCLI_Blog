...
export default {
    ...
    data () {
        return {
            ...
            authors: ['Stephen King', 'Franz Kafka', 'Jack London'],
            submitted: false
        }
    },
    methods: {
        post: function() {
            this.$http.post('https://vuecliblog.firebaseio.com/posts.json', this.blog).then(function(data){
                console.log(data);
                this.submitted = true
            });
        }
